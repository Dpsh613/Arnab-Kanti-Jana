...
const ResearchExpertisePage = () => {
  return (
    <>
      <SEO
        title="Research Methodologies & Experimental Techniques | Arnab Kanti Jana"
        description="Advanced methodologies in condensed matter physics including solid-state synthesis, synchrotron XRD, neutron scattering, muon spin relaxation, spectroscopy, magnetometry, transport measurements and computational analysis."
        url="https://arnab-kanti-jana.vercel.app/research-expertise"
      />
      <motion.section
